...
/*
  Since ChallengeFunction is READ_WRITE variable, onChallengeFunctionChange() is
  executed every time a new value is received from IoT Cloud.
*/
void onChallengeFunctionChange()  {
  // Add your code here to act upon ChallengeFunction change
}
...
void challenge_alarm() {
  ...
  carrier.display.setTextSize(3);
  carrier.display.setCursor(50, 100);
  carrier.display.println("IoT Rocks!");
  ...
  carrier.display.setTextSize(3);
  carrier.display.setCursor(50, 100);
  carrier.display.println("IoT Rocks Again!");
  // carrier.Buzzer.noSound();
  delay(1000);
} 